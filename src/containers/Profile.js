            ...
            <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col gap-0.5 px-2'>
                        ...
                        <div className='flex flex-row items-center gap-2'>
                            ...
                            {enableNameEdit ?
                                ...
                                :
                                <FiEdit3 onClick={() => setEnableNameEdit(true)} className="h-5 w-5 text-rose-400 cursor-pointer" />
                            }
                        </div>
                    </div>
                    <div className='flex flex-col gap-0.5 px-2'>
                        ...
                        <div className='flex flex-row items-center gap-2'>
                            ...
                            {enableEmailEdit ?
                                ...
                                :
                                <FiEdit3 onClick={() => setEnableEmailEdit(true)} className="h-5 w-5 text-rose-400 cursor-pointer" />
                            }
                        </div>
                    </div>
                    <div className='flex flex-col gap-0.5 px-2'>
                        ...
                        <div className='flex flex-row items-center gap-2'>
                            ...
                            {enablePassEdit ?
                                ...
                                :
                                <FiEdit3 onClick={() => setEnablePassEdit(true)} className="h-5 w-5 text-rose-400 cursor-pointer" />
                            }
                        </div>
                    </div>
                </div>
                <div className='flex flex-col gap-2'>
                    ...
                    {/* <div className='flex flex-col px-2'>
                        <p className="font-caviar text-sm font-bold tracking-wide text-gray-700 dark:text-neutral-300">Preferred Salary</p>
                        <input type="number" className="font-caviar w-full text-sm font-bold tracking-wide rounded-md p-2 bg-transparent text-gray-700 dark:text-gray-300 disabled:text-slate-400 disabled:dark:text-neutral-500 border-2 border-slate-400 dark:border-neutral-600" value={user.info.username} />
                    </div> */}
                    <div className='flex flex-col gap-0.5 px-2'>
