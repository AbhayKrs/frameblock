...
const Signin = (props) => {
    ...
    return (
        <div className="flex flex-col gap-8 font-caviar p-2">
            <div className='flex flex-col gap-2'>
                <h1 className="text-5xl font-bold text-gray-700 dark:text-gray-300 ">Welcome back</h1>
                <h2 className="text-2xl font-bold tracking-wide text-gray-700 dark:text-gray-400 ">Continue with Google or enter your details.</h2>
