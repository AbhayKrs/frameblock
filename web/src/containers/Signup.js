...
import { handle_user_signUp } from '../utils/api_routes';
            ...
            <div className='flex flex-col gap-4'>
                ...
                <div className="relative flex items-center">
                    <input
                        name="username"
                        value={username}
                        className="font-nunito bg-slate-50 dark:bg-neutral-700 text-gray-800 dark:text-gray-200 text-neutral-500 dark:placeholder:text-neutral-400 rounded-lg py-2 px-4 w-full focus:outline-none"
                        type="text"
                ...
                <div className='flex flex-row space-x-2'>
                    <button onClick={onSubmitClick} className='w-fit font-nunito font-bold tracking-wide bg-amber-300 hover:bg-indigo-600 text-gray-200 px-6 py-2 rounded-md text-lg'>Sign Up</button>
                    <button onClick={onCancelClick} className='w-fit font-nunito font-bold tracking-wide bg-gray-400 hover:bg-gray-300 text-neutral-900 px-6 py-2 rounded-md text-lg'>Cancel</button>
                </div>
                <p className='font-nunito text-gray-700 dark:text-neutral-400 text-sm'>By clicking Sign Up, I confirm that I have read and agree to the Artyst <button type='button' className='text-sm font-bold text-amber-300'>Terms of Service</button> and <button type='button' className='text-sm font-bold text-amber-300'>Privacy Policy</button>.</p>
            </div>
        </div>
    )
}
