...
const Home = () => {
    ...
    return (
        <div className="flex flex-col gap-4 items-center font-nunito text-center">
            <div className="flex flex-col items-center space-y-2">
                <h1 className="text-4xl font-bold text-gray-700 dark:text-gray-300">Be job ready in just minutes!</h1>
            ...
            <div className="grid xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 px-2 lg:px-[7.5rem] items-center text-start">
                <div className="flex flex-row gap-5">
                    ...
                    <div className='flex flex-col w-9/12 space-y-1'>
                        ...
                        <p className="text-base tracking-wide text-gray-700 dark:text-gray-300">Click, Update and Build your perfect Resumes! </p>
                    </div>
                </div>
                <div className="flex flex-row gap-5">
                    ...
                    <div className="flex flex-col w-9/12 space-y-1">
                        ...
                        <p className="text-base tracking-wide text-gray-700 dark:text-gray-300">Automated tools to design as per you preference. </p>
                    </div>
                </div>
                <div className="flex flex-row gap-5">
                ...
                <div className="flex flex-row gap-5">
                    ...
                    <div className="flex flex-col w-9/12 space-y-1">
                        ...
                        <p className="text-base tracking-wide text-gray-700 dark:text-gray-300">Certified Automated Tracking System (ATS) friendly resumes to prevent any filter rejections. </p>
                    </div>
                </div>
                <div className="flex flex-row gap-5">
                    ...
                    <div className="flex flex-col w-9/12 space-y-1">
                        ...
                        <p className="text-base tracking-wide text-gray-700 dark:text-gray-300">With over 5+ language supports switch between : English, Spanish, Japanese, French and Chinese. </p>
                    </div>
                </div>
                <div className="flex flex-row gap-5">
                    ...
                    <div className="flex flex-col w-9/12 space-y-1">
                        ...
                        <p className="text-base tracking-wide text-gray-700 dark:text-gray-300">A resume contains various personal details. Be assured that all your data is protected and secured against any harm. </p>
                    </div>
                </div>
            </div >
        </div >
